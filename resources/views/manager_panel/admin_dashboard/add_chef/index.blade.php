...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Chefs</h1>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0">Chefs</h4>
                            <a href="{{ route('manager.chef.add') }}" class="btn btn-primary ms-auto">Add Chef</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($chef as $m)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('manager.chef.edit', $m->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                                ...
                                                                <button onclick="ajaxRequest(this)"
                                                                    data-url="{{ route('manager.menu.destroy', $m->id) }}"
                                                                    class="btn
                                                         w-sm btn-danger"
