    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <h1 class="page-title fw-semibold fs-18 mb-0">Active Order List</h1>
                <div class="ms-md-1 ms-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Active Order List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div id="DataTables_Table_0_wrapper"
                            ...
                            <table id="orderTable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @if($orders->isEmpty())
                                        <tr>
                                            <td colspan="9" class="text-center">No active orders found.</td>
                                        </tr>
                                    @else
                                        @foreach ($orders as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="btn btn-info btn-sm view-order-btn" data-id="{{ $order->id }}">View</a>
                                                    <div class="dropdown d-inline">
                                                        <button class="btn btn-secondary dropdown-toggle btn-sm" type="button" id="statusDropdown{{ $order->id }}" data-bs-toggle="dropdown" aria-expanded="false">
                                                            Status
                                                        </button>
                                                        <ul class="dropdown-menu" aria-labelledby="statusDropdown{{ $order->id }}">
                                                            ...
                                                            <li><a class="dropdown-item" href="javascript:void(0);" data-status="2" data-id="{{ $order->id }}">Return</a></li>
