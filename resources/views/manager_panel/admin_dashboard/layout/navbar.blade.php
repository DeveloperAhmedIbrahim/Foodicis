        ...
        <div class="header-content-left d-flex align-items-center">
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="{{ route('manager.dashboard') }}" class="header-logo">
        ...
        <div class="header-content-right d-flex align-items-center">
            ...
            <div class="header-element">
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end">
                    <li><a class="dropdown-item d-flex" href="{{ url('manager/profile-setting') }}"><i class="ti ti-user-circle fs-18 me-2 op-7"></i> My Profile</a></li>
                    <hr class="m-0">
                    <li>
