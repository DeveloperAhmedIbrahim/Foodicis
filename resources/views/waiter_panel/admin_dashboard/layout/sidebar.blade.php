        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href=""><i
                                    data-feather="box"></i><span>POS</span></a></li>
                ...
                <li class="submenu-open">
                    <h6 class="submenu-hdr">Inventory Management</h6>
                    <ul>
                        <li><a href=""><i
                                    data-feather="box"></i><span>Ingredeints</span></a></li>
                                    <li><a href=""><i
                                        data-feather="box"></i><span>Purchase Ingredeints</span></a></li>
                                        <li><a href="./product-list.html"><i
                                            data-feather="box"></i><span>Total Stock</span></a></li>
                    </ul>
                </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="./product-list.html"><i
                                    data-feather="box"></i><span>Menu</span></a></li>
                    </ul>
                </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href=""><i
                                    data-feather="box"></i><span>Orders</span></a></li>
                    </ul>
                </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="./product-list.html"><i
                                    data-feather="box"></i><span>Waste Report</span></a></li>
                                    <li><a href="./product-list.html"><i
                                        data-feather="box"></i><span>Sale Report</span></a></li>
                                        <li><a href="./product-list.html"><i
                                            data-feather="box"></i><span>Purchase Report</span></a></li>
                    </ul>
                </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href=""><i
                                    data-feather="box"></i><span>Employees</span></a></li>
                    </ul>
                </li>
