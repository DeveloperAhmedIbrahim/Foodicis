                ...
                <div class="login-content">
                    <div class="login-userset">
                            ...
                            <div class="form-login authentication-check">
                                <div class="row">
                                    <div class="col-12 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="text-end">
                                            <a class="forgot-link" href="{{ route('chef.password.request') }}">Forgot Password?</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {{-- <div class="signinform">
                            <h4>New on our platform? <a href="{{ route('chef.register') }}" class="hover-a">Create an account</a></h4>
                        </div> --}}
                        ...
                        {{-- <div class="form-sociallink">
                            ...
                            <div class="my-4 d-flex justify-content-center align-items-center copyright-text">
                                <p>Copyright &copy; 2023 FoodICIS. All rights reserved</p>
                            </div>
                        </div> --}}
                    </div>
                </div>
