                                        ...
                                        @foreach ($dishes as $dish)
                                            <tr>
                                                ...
                                                <td> <img style="width: 100px; height: 50px;"
                                                        src="{{ asset('dish_images') }}/{{ $dish->image }}"></td>
                                                <td>
                                                    <!-- Example actions like edit, delete, etc. -->
                                                    <a href="{{ route('chef.dish.editdish', $dish->id) }}"
                                                        class="btn btn-sm btn-primary">Edit</a>
                                                    <button class="btn btn-sm btn-danger remove-item-btn"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#remove_data{{ $dish->id }}">remove</button>
                                                </td>
                                            </tr>
                                            <div id="remove_data{{ $dish->id }}" class="modal fade zoomIn"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                                ...
                                                                <button onclick="ajaxRequest(this)"
                                                                    data-url="{{ route('chef.dish.deletedish', $dish->id) }}"
                                                                    class="btn
                                                         w-sm btn-danger"
