...
@include('chef_panel.admin_dashboard.layout.header')
<body>

    <!-- Start Switcher -->
 @include('chef_panel.admin_dashboard.layout.switcher')
    <!-- End Switcher -->

    <div class="page">
         <!-- app-header -->
     @include('chef_panel.admin_dashboard.layout.navbar')
        <!-- /app-header -->
        <!-- Start::app-sidebar -->
@include('chef_panel.admin_dashboard.layout.sidebar')
        <!-- End::app-sidebar -->
       ...
       @yield('content')
        ...
        <!-- Footer Start -->
@include('chef_panel.admin_dashboard.layout.footer')
        <!-- Footer End -->
