            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="submenu">
                                <a href="{{ route('admin.dashboard') }}" class="subdrop active"><i
                    ...
                    <li class="submenu-open">
                        <h6 class="submenu-hdr">Manager Requests</h6>
                        <ul>
                            <li><a href="{{ route('admin.manager_request') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>View
                                        Requests</span></a></li>
                    ...
                    <li class="submenu-open">
                        <h6 class="submenu-hdr">Contact Requests</h6>
                        <ul>
                            <li><a href="{{ route('admin.contact.contact_request') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg><span>View
                                        Requests</span></a></li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                        <h6 class="submenu-hdr">Contact page Requests</h6>
                        <ul>
                            <li><a href="{{ route('admin.contact.lead_contact_request') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg><span>View
                                        contact Requests</span></a></li>
                        </ul>
                    </li>
