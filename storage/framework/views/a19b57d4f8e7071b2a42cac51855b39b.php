...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('front_assets/images/logo/logo.avif')); ?>" />
    ...
    <meta property="og:image" content="<?php echo e(asset('front_assets/images/common/seo-image.jpg')); ?>">
    ...
    <meta name="twitter:description"
        content="Full-featured, Professional-looking SaaS, Software and Startup Site Template.">
    <meta name="twitter:image" content="<?php echo e(asset('front_assets/images/common/seo-image.jpg')); ?>">
    ...
    <link rel="preload" href="<?php echo e(asset('front_assets/js/libs/jquery.min.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/libs/scrollmagic.min.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/libs/swiper-bundle.min.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/libs/anime.min.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/helpers/data-attr-helper.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/helpers/swiper-helper.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/helpers/anime-helper.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/helpers/anime-helper-defined-timelines.js')); ?>"
        as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/uikit-components-bs.js')); ?>" as="script">
    <link rel="preload" href="<?php echo e(asset('front_assets/js/app.js')); ?>" as="script">

    <!-- app head for bootstrap core -->
    <script src="<?php echo e(asset('front_assets/js/app-head-bs.js')); ?>"></script>

    <!-- include uni-core components -->
    <link rel="stylesheet" href="<?php echo e(asset('front_assets/js/uni-core/css/uni-core.min.css')); ?>">

    <!-- include styles -->
    <link rel="stylesheet" href="<?php echo e(asset('front_assets/css/unicons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('front_assets/css/prettify.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('front_assets/css/swiper-bundle.min.css')); ?>">

    <!-- include main style -->
    <link rel="stylesheet" href="<?php echo e(asset('front_assets/css/theme/main.min.purge.css')); ?>">

    <!-- include scripts -->
    <script src="<?php echo e(asset('front_assets/js/uni-core/js/uni-core-bundle.min.js')); ?>"></script>
</head>
            ...
            <div class="row md:child-cols-6 col-match g-0">
                <div class="d-none md:d-flex">
                    <div class="position-relative w-100 ratio-1x1 rounded-2 overflow-hidden">
                        <img class="media-cover" src="<?php echo e(asset('front_assets/images/common/newsletter.jpg')); ?>"
        ...
        <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
            <header class="uc-offcanvas-header hstack justify-between items-center pb-2 bg-white dark:bg-gray-900">
                <div class="uc-logo">
                    <a class='h5 text-none text-gray-900 dark:text-white' href='index.html'>
                        <img class="w-32px" src="<?php echo e(asset('front_assets/images/logo/logo.avif')); ?>" alt="Lexend">
                    </a>
                </div>
                <button
            ...
            <div class="panel">
                ...
                <ul class="nav-y gap-narrow fw-medium fs-6" data-uc-nav>
                    ...
                    <li><a href='<?php echo e(route('ai_page')); ?>'>AI Restaurant Management</a></li>
                    <li><a href='<?php echo e(route('reporting_analytics')); ?>'>Reporting & Analytics</a></li>
                                ...
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                            src="<?php echo e(asset('front_assets/images/common/products/img-07.jpg')); ?>"
                                            alt="Laptop Cover">
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        class="featured-image m-0 rounded ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden">
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                            src="<?php echo e(asset('front_assets/images/common/products/img-08.jpg')); ?>"
                                            alt="Disney Toys">
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        class="featured-image m-0 rounded ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden">
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                            src="<?php echo e(asset('front_assets/images/common/products/img-09.jpg')); ?>"
                                            alt="Screen Axe">
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        class="featured-image m-0 rounded ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden">
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                            src="<?php echo e(asset('front_assets/images/common/products/img-10.jpg')); ?>"
                                            alt="Airpods Pro">
                        ...
                        <div class="uc-navbar-left">
                            <div class="uc-logo text-dark dark:text-white">
                                <a class='panel text-none' href='index-5.html' style='width: 140px'>
                                    <img class="dark:d-none" src="<?php echo e(asset('front_assets/images/logo/logo.avif')); ?>"
                                        alt="Lexend">
                                    <img class="d-none dark:d-block"
                                        src="<?php echo e(asset('front_assets/images/logo/logo.avif')); ?>" alt="Lexend">
                                </a>
                            </div>
                            <ul
...
<?php /**PATH D:\laragon\www\Foodicis\resources\views/front_layout/header.blade.php ENDPATH**/ ?>