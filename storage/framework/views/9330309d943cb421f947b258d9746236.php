...
<?php echo $__env->make('admin_panel.admin_dashboard.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<body>

    <!-- Start Switcher -->
 <?php echo $__env->make('admin_panel.admin_dashboard.layout.switcher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- End Switcher -->

    <div class="page">
         <!-- app-header -->
     <?php echo $__env->make('admin_panel.admin_dashboard.layout.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- /app-header -->
        <!-- Start::app-sidebar -->
<?php echo $__env->make('admin_panel.admin_dashboard.layout.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- End::app-sidebar -->
       ...
       <?php echo $__env->yieldContent('content'); ?>
        ...
        <!-- Footer Start -->
<?php echo $__env->make('admin_panel.admin_dashboard.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Footer End -->
...
<script src="<?php echo e(asset('assets/js/custom.js')); ?>"></script>
    ...
    <script>
      jQuery.ajax({
          url: "<?php echo e(route('admin.restaurants.stats')); ?>",
          method: "POST",
          data: {
      ...
      jQuery.ajax({
          url: "<?php echo e(route('admin.leads.stats')); ?>",
          method: "POST",
          data: {
            _token: '<?php echo e(csrf_token()); ?>'
          },
...
</html><?php /**PATH D:\laragon\www\Foodicis\resources\views/admin_panel/admin_dashboard/layout/layout.blade.php ENDPATH**/ ?>