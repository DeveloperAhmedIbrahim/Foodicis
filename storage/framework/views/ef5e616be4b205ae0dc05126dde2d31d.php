            ...
            <div class="container max-w-xl">
                <div
                    ...
                    <div class="panel w-100 sm:w-350px xl:w-450px">
                        <form class="row child-cols g-1" method="POST" action="<?php echo e(route('subscriptions.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <div>
...
<script defer src="<?php echo e(asset('front_assets/js/libs/jquery.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/libs/bootstrap.min.js')); ?>"></script>

<!-- include scripts -->
<script defer src="<?php echo e(asset('front_assets/js/libs/anime.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/libs/swiper-bundle.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/libs/scrollmagic.min.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/helpers/data-attr-helper.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/helpers/swiper-helper.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/helpers/anime-helper.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/helpers/anime-helper-defined-timelines.js')); ?>"></script>
<script defer src="<?php echo e(asset('front_assets/js/uikit-components-bs.js')); ?>"></script>

<!-- include app script -->
<script defer src="<?php echo e(asset('front_assets/js/app.js')); ?>"></script>
...
<?php /**PATH D:\laragon\www\Foodicis\resources\views/front_layout/footer.blade.php ENDPATH**/ ?>