        ...
        <div class="header-content-left d-flex align-items-center">
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="<?php echo e(route('manager.dashboard')); ?>" class="header-logo">
                ...
                <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-sm-block d-none">
                            <p class="fw-semibold mb-0 lh-1"><?php echo e(Auth::user() ? Auth::user()->name : 'Profile'); ?></p>
                            <span class="op-7 fw-normal d-block fs-11">Admin</span>
                        </div>
                    </div>
                </a>
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end">
                    <li><a class="dropdown-item d-flex" href="<?php echo e(url('manager/profile-setting')); ?>"><i class="ti ti-user-circle fs-18 me-2 op-7"></i> My Profile</a></li>
                    <hr class="m-0">
                    <li>
...
<?php /**PATH D:\laragon\www\Foodicis\resources\views/manager_panel/admin_dashboard/layout/navbar.blade.php ENDPATH**/ ?>