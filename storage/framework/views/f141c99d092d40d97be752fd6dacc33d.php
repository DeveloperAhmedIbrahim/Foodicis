        ...
        <div class="header-content-right d-flex align-items-center">
            ...
            <div class="header-element">
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end">
                    <li><a class="dropdown-item d-flex" href="<?php echo e(url('chef/profile-setting')); ?>"><i class="ti ti-user-circle fs-18 me-2 op-7"></i> My Profile</a></li>
                    <hr class="m-0">
                    <li>
                        <form method="POST" action="<?php echo e(route('chef.logout')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\Foodicis\resources\views/chef_panel/admin_dashboard/layout/navbar.blade.php ENDPATH**/ ?>