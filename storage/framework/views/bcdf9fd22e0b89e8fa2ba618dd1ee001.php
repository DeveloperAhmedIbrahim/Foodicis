<aside class="app-sidebar sticky" id="sidebar">
        ...
        <div class="main-sidebar" id="sidebar-scroll">
            ...
            <nav class="main-menu-container nav nav-pills flex-column sub-open">
                ...
                <ul class="main-menu">
                    ...
                    <!-- Start::slide -->
                    <li class="slide has-sub">
                        <a href="<?php echo e(route('admin.manager_request')); ?>" class="side-menu__item">
                    ...
                    <!-- Start::slide -->
                    <li class="slide has-sub">
                        <a href="<?php echo e(route('admin.contact.contact_request')); ?>" class="side-menu__item">
                            <i class="bx bx-file-blank side-menu__icon"></i>
                            <span class="side-menu__label">View
                               Leads Requests</span>
                            <i class="fe fe-chevron-right side-menu__angle"></i>
                    ...
                    <!-- Start::slide -->
                    <li class="slide has-sub">
                        <a href="<?php echo e(route('admin.contact.lead_contact_request')); ?>" class="side-menu__item">
                            <i class="bx bx-file-blank side-menu__icon"></i>
                            <span class="side-menu__label">View
 ...
 <!-- Start::slide -->  
<li class="slide">
        <form method="POST" action="<?php echo e(route('admin.logout')); ?>" class="side-menu__item">
            <?php echo csrf_field(); ?>
    ...
    </aside><?php /**PATH D:\laragon\www\Foodicis\resources\views/admin_panel/admin_dashboard/layout/sidebar.blade.php ENDPATH**/ ?>