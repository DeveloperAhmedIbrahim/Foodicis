                        ...
                        <div class="pos-categories tabs_wrapper">
                            ...
                            <ul class="tabs owl-carousel pos-category">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li id="cat<?php echo e($category->id); ?>">
                                        <a href="javascript:void(0);">
                                            <img src="<?php echo e(asset('category_images/' . $category->image)); ?>" alt="Categories">
                                        </a>
                                        <h6><a href="javascript:void(0);"><?php echo e($category->name); ?></a></h6>
                                        <span><?php echo e($category->dishes->count()); ?> Items</span>
                                    </li>
...
<?php echo $__env->make('manager_panel.admin_dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Foodicis\resources\views/manager_panel/admin_dashboard/pos/index.blade.php ENDPATH**/ ?>