                            ...
                            <div class="sm:col-auto">
                                <div class="hero-scroll-scene panel sm:w-550px sm:h-600px lg:w-450px lg:h-500px xl:w-600px xl:h-650px"
                                    ...
                                    <figure
                                        ...
                                        <img class="media-cover image" src="<?php echo e(asset('front_assets/images/media/1.jpg')); ?>"
                                            alt="image">
                                    </figure>
                                    ...
                                    <div class="hero-five-account position-absolute sm:w-250px lg:w-200px xl:w-300px d-none sm:d-block"
                                        data-anime="translateY: [24, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 750; delay: 750;"
                                        style="bottom: 20%">
                                        <img src="<?php echo e(asset('front_assets/images/template/hero-05-account.png')); ?>"
                                            alt="Account"
                                        ...
                                        <div
                                            ...
                                            <figure
                                                ...
                                                <img class="media-cover image"
                                                    src="<?php echo e(asset('front_assets/images/media/2.jpg')); ?>"
                                                    alt="image title">
                                            </figure>
                                        </div>
                                        <div
                                    ...
                                    <div class="row child-cols-12 lg:child-cols-6 col-match items-center g-0">
                                        <div class="lg:order-2"
                                            ...
                                            <figure
                                                ...
                                                <img class="media-cover image"
                                                    src="<?php echo e(asset('front_assets/images/media/3.jpg')); ?>"
                                                    alt="image title">
                                            </figure>
                                        </div>
                                        <div class="order-1"
                ...
                <div class="panel row child-cols-12 lg:child-cols-6 g-0">
                    <div class="order-1 lg:order-0">
                        <div class="panel overflow-hidden rounded-3 h-100 min-h-350px">
                            <figure class="panel h-100 m-0 rounded">
                                ...
                                <img class="media-cover image"
                                    src="<?php echo e(asset('front_assets')); ?>/images/template/hero-contact.jpg" alt="Hero image">
                            </figure>
                    ...
                    <div class="order-0 lg:order-1">
                        <form id="inquiry-form" class="vstack gap-2 p-3 sm:p-6 xl:p-8"
                            action="<?php echo e(route('contact.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('front_layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Foodicis\resources\views/frontend/home.blade.php ENDPATH**/ ?>