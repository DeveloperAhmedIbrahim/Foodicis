        ...
        <div class="row">
                                            ...
                                            <div class="flex-fill ms-3">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div>
                                                        ...
                                                        <h4 class="fw-semibold mt-1"><?php echo e(@$activeOrders); ?></h4>
                                                    </div>
                                            ...
                                            <div class="flex-fill ms-3">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div>
                                                        ...
                                                        <h4 class="fw-semibold mt-1"><?php echo e(@$completeOrders); ?></h4>
                                                    </div>
                                            ...
                                            <div class="flex-fill ms-3">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div>
                                                        ...
                                                        <h4 class="fw-semibold mt-1"><?php echo e(@$totalDishes); ?></h4>
                                                    </div>
                                            ...
                                            <div class="flex-fill ms-3">
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <div>
                                                        ...
                                                        <h4 class="fw-semibold mt-1"><?php echo e(@$totalWasteAmount); ?></h4>
                                                    </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">Total Orders in <?php echo e(date('Y')); ?></div>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xl-6">
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">Total Waste Units in <?php echo e(date('Y')); ?></div>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('chef_panel.admin_dashboard.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Foodicis\resources\views/chef_panel/admin_dashboard/dashboard.blade.php ENDPATH**/ ?>